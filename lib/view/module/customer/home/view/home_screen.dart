              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ServiceCartWidget(image: AppImages.bespoke, text: "Bespoke concierge services"),
                      HeightGap(height: 16),
                      ServiceCartWidget(image: AppImages.privateDriver, text: "Private drivers"),
                      HeightGap(height: 16),
                      ServiceCartWidget(image: AppImages.securityPerson, text: "Security personnel management"),
                    ],
                  ),
                ),
              ),
