          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: CustomTextFromField(hintText: 'Enter your email', prefixIcon: Icons.email_outlined,),
              ),
              HeightGap(height: 20.h),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: CustomTextFromField(hintText: 'Enter your Location', prefixIcon: Icons.location_on_outlined,),
              ),
              Spacer(),
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(image: AssetImage(AppImages.buttonBg),
                      fit: BoxFit.cover
                    ),
                  ),
                  child: Center(
                    child: Text('Save & Change',style: TextStyles.regular20.copyWith(
