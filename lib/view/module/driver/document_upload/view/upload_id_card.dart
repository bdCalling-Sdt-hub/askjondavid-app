                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Take a photo of your ID card', style: TextStyles.regular24.copyWith(
                        fontWeight: FontWeight.w500,
                        color: AppColors.appGrayColor
                      ),),
                      HeightGap(height: 8.h),
                      Text(AppString.uploadIdCart, style: TextStyles.regular12.copyWith(
    ...
    return Obx(
        ...
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                serviceController.pickIdFrontPartFromCamera();
              },
              child: Container(
                height: 120.h,
                ...
                child: Center(
                  child: serviceController.selectedIdCardFrontPath.value.isEmpty
                      ? SvgPictureWidget(
                    imageUrl: AppImages.captureFront,
                    height: 32.h,
                    width: 32.w,
                  )
                      : Image.file(File(serviceController.selectedIdCardFrontPath.value),
                      fit: BoxFit.fitWidth),
                ),
              ),
            ),
            ...
            GestureDetector(
              onTap: () {
                serviceController.pickIdBackPartFromCamera();
              },
              child: Container(
                height: 120.h,
                width: MediaQuery.of(context).size.width/2.3,
                decoration: DottedDecoration(
                    shape: Shape.box, borderRadius: BorderRadius.circular(8.r)),
                child: Center(
                  child: serviceController.selectedIdCardBackPath.value.isEmpty
                      ? SvgPictureWidget(
                    imageUrl: AppImages.captureBack,
                    height: 32.h,
                    width: 32.w,
                  )
                      : Image.file(File(serviceController.selectedIdCardBackPath.value),
                      fit: BoxFit.fitWidth),
                ),
              ),
            ),
