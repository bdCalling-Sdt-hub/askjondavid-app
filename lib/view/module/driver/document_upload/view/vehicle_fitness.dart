...
class VehicleFitness extends StatelessWidget {
  const VehicleFitness({super.key});
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Take a photo of your vehicle fitness certificate', style: TextStyles.regular24.copyWith(
    ...
    return Obx(() => Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                serviceController.pickVehicleFitnessFrontPartFromCamera();
              },
              child: Container(
                height: 120.h,
                ...
                child: Center(
                  child: serviceController.selectedVehicleFitnessFrontPart.value.isEmpty
                      ? SvgPictureWidget(
                    imageUrl: AppImages.captureFront,
                    height: 32.h,
                    width: 32.w,
                  )
                      : Image.file(File(serviceController.selectedVehicleFitnessFrontPart.value),
                      fit: BoxFit.fitWidth),
                ),
              ),
            ),
            ...
            GestureDetector(
              onTap: () {
                serviceController.pickVehicleFitnessBackPartFromCamera();
              },
              child: Container(
                height: 120.h,
                width: MediaQuery.of(context).size.width/2.3,
                decoration: DottedDecoration(
                    shape: Shape.box, borderRadius: BorderRadius.circular(8.r)),
                child: Center(
                  child: serviceController.selectedVehicleFitnessBackPart.value.isEmpty
                      ? SvgPictureWidget(
                    imageUrl: AppImages.captureBack,
                    height: 32.h,
                    width: 32.w,
                  )
                      : Image.file(File(serviceController.selectedVehicleFitnessBackPart.value),
                      fit: BoxFit.fitWidth),
                ),
              ),
            ),
