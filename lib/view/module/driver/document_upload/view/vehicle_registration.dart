                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Take a photo of your vehicle registration', style: TextStyles.regular24.copyWith(
    ...
    return Obx(() => Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                serviceController.pickVehicleRegistrationFrontPartFromCamera();
              },
              child: Container(
                height: 120.h,
                ...
                child: Center(
                  child: serviceController.selectedVehicleRegistrationFrontPart.value.isEmpty
                      ? SvgPictureWidget(
                    imageUrl: AppImages.captureFront,
                    height: 32.h,
                    width: 32.w,
                  )
                      : Image.file(File(serviceController.selectedVehicleRegistrationFrontPart.value),
                      fit: BoxFit.fitWidth),
                ),
              ),
            ),
            ...
            GestureDetector(
              onTap: () {
                serviceController.pickVehicleRegistrationBackPartFromCamera();
              },
              child: Container(
                height: 120.h,
                width: MediaQuery.of(context).size.width/2.3,
                decoration: DottedDecoration(
                    shape: Shape.box, borderRadius: BorderRadius.circular(8.r)),
                child: Center(
                  child: serviceController.selectedVehicleRegistrationBackPart.value.isEmpty
                      ? SvgPictureWidget(
                    imageUrl: AppImages.captureBack,
                    height: 32.h,
                    width: 32.w,
                  )
                      : Image.file(File(serviceController.selectedVehicleRegistrationBackPart.value),
                      fit: BoxFit.fitWidth),
                ),
              ),
            ),
