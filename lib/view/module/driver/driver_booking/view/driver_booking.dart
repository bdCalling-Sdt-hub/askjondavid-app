...
import 'package:luxury_car_service/view/module/driver/driver_booking/view/tab/driver_booking_completed.dart';
import 'package:luxury_car_service/view/module/driver/driver_booking/view/tab/driver_booking_in_progress.dart';
import 'package:luxury_car_service/view/module/driver/driver_booking/view/tab/driver_booking_pending.dart';
import 'package:luxury_car_service/view/module/driver/driver_booking/view/tab/driver_booking_reject.dart';
  ...
  Expanded buildTabBarView(context) {
    return Expanded(
      child: TabBarView(
        ...
        children: [
          DriverBookingPending(),
          DriverBookingInProgress(),
          DriverBookingReject(),
          DriverBookingCompleted()
        ],
      ),
    );
  }
